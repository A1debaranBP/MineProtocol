...
public class FishMaAziEdge extends SwordItem {

    private static final int BOOST = 3600;
    private static final int LEVEL = 2;
    private static final int COOLDOWN = 6000;

    public FishMaAziEdge() {
        super(FishToolTiers.FISH,1,-2.0F,new Properties());
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            ...
            player.addEffect(new MobEffectInstance(MobEffects.WATER_BREATHING, BOOST, LEVEL));
