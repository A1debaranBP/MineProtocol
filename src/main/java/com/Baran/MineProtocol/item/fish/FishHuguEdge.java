...
public class FishHuguEdge extends SwordItem {
    public FishHuguEdge() {
        super(FishToolTiers.FISH,3,-1.5F,new Properties());
    }
    ...
    public boolean hurtEnemy(ItemStack stack, LivingEntity target, LivingEntity attacker) {
        if (!attacker.level().isClientSide) {
            ...
            target.addEffect(new MobEffectInstance(MobEffects.POISON, 200, 0)); // 60tick = 3秒
        }
