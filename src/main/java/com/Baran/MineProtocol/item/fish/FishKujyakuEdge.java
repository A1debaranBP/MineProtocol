...
public class FishKujyakuEdge extends SwordItem {

    private static final int BOOST = 1200;
    private static final int LEVEL = 2;
    private static final int COOLDOWN = 3600;

    public FishKujyakuEdge() {
        super(FishToolTiers.FISH,2,-1.0F,new Properties());
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            ...
            player.addEffect(new MobEffectInstance(MobEffects.FIRE_RESISTANCE, BOOST, LEVEL));
